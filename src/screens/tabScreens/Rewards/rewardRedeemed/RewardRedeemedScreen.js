...
export default class RewardRedeemedScreen extends React.PureComponent {
  constructor() {
    super();
    this.state = {
      shoot: false,
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.thankYouContainer}>
          ...
          <Text style={styles.thankTextContainer} children={"Thank You"} />
        </View>

        <View style={styles.textContainer}>
          <Text
            style={styles.textStyling}
            children={"We have successfully added 1mg"}
          />
          <Text
            style={styles.textStyling}
            children={"Diabetes care plan to your"}
          />
          <Text style={styles.textStyling} children={"account"} />
        </View>
              ...
              <RNSwipeVerify
                ...
                onVerified={() => {
                  const resetAction = StackActions.reset({
                    index: 0,
                    actions: [
                      NavigationActions.navigate({ routeName: "RewardScreen" })
                    ]
                  });
